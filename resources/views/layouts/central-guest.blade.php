...
<head>
    ...
    <title>{{ config('app.name', 'Barangay Reservation') }} &mdash; Administration</title>
    ...
    <div class="relative hidden flex-col justify-between overflow-hidden hero-gradient lg:flex lg:w-[52%] xl:w-[55%]">
        ...
        <div class="relative z-10 flex flex-col justify-center flex-1 px-16 py-20">
            <div class="flex items-center gap-4 mb-14">
                ...
                <div>
                    <p class="text-xs font-semibold tracking-widest text-indigo-400 uppercase">Republic of the Philippines</p>
                    <p class="text-white font-bold text-lg leading-tight">Barangay Reservation System</p>
                </div>
            </div>
            ...
            <p class="text-slate-400 text-lg leading-relaxed max-w-md">
                Manage all barangay tenants, subscription plans, and system-wide analytics from a single secure dashboard.
            </p>

            <ul class="mt-10 space-y-4">
                @foreach([
                    ['Multi-tenant domain isolation', 'M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z'],
                    ['Subscription plan management', 'M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h3m-3.348 4.5a4.502 4.502 0 0 0 6.304-6.304L12 10.5'],
    ...
    <div class="flex flex-1 flex-col justify-center relative bg-white dark:bg-slate-950 px-6 py-12 sm:px-12 lg:px-16 xl:px-24 transition-colors duration-300">
        ...
        <div class="mx-auto w-full max-w-md">
            ...
            <div class="lg:hidden flex items-center gap-3 mb-10">
                ...
                <span class="font-bold text-slate-900 dark:text-slate-100">Brgy Reservation System</span>
            </div>

            <div class="animate-in">
                <h2 class="text-2xl font-bold text-slate-900 dark:text-slate-100 tracking-tight">Welcome back</h2>
                <p class="mt-1.5 text-sm text-slate-500 dark:text-slate-400">Sign in to the Central Administration Panel</p>
            </div>

            <div class="mt-8 animate-in delay-1">
                {{ $slot }}
            </div>

            <p class="mt-10 text-center text-xs text-slate-400 dark:text-slate-500 animate-in delay-4">
